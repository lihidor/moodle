...
class icon_system_fontawesome extends icon_system_font {
    ...
    public function get_core_icon_map() {
        return [
            ...
            'core:i/grade_correct_picked' => 'fa-check text-success',
            'core:i/grade_correct_unpicked' => 'fa-check text-success-unpicked',
            'core:i/grade_incorrect' => 'fa-remove text-danger',
            'core:i/grade_incorrect_picked' => 'fa-remove text-danger',
            'core:i/grade_incorrect_unpicked' => 'fa-remove text-danger-unpicked',
            'core:i/grade_partiallycorrect' => 'fa-check-square',
            'core:i/grade_partiallycorrect_picked' => 'fa-check-square',
            'core:i/grade_partiallycorrect_unpicked' => 'fa-check-square text-partial-unpicked',
